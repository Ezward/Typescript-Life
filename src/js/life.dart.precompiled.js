...
["", "../dart/main.dart", , F, {
  ...
  main: [function() {
    ...
    t1.set$width(theStage, C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(theStage.clientWidth)));
    t1.set$height(theStage, C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(theStage.clientHeight)));
  ...
  main_animationFrame: {
    "^": "Closure:19;thePopulation_0,theRenderer_1",
